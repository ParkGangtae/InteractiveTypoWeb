...
class App {
    constructor() {
        ...
        this.countryList = ['../korean.html', 'United State', 'China', 'Japan', 'Saudi', 'Austrailia', 'Brazil', 'EUROPE'];
                  ...
                  gsap.to(this._scene.background,{
                    ...
                    onComplete: () => {                      
                      setTimeout(() => {
                        ...
                        window.location.href = this.countryList[this.countryindex];
                      }, 1000); 
                    }
                  });
                }
      ...
      _setupModel_sphere(){
        ...
        const earthTexture = textureLoader.load('../src/images/earth_texture_10k.jpg');
      ...
      updateText() {
        ...
        const textList = ['환영합니다', 'WELCOME','欢迎光临','ようこそ','السلام عليكم', 'WELCOME', 'HOLA', 'Bienvenidos'];
        ...
        loader.load(
          ...
          (font) => {
            ...
            this.textMesh.geometry = new TextGeometry(textList[this.text_index], {
              font: font,
      ...
      update(time) {
        ...
        const textPosition = cameraDirection.clone().multiplyScalar(distanceToCamera);
